 ...
 *
 * @MigrateSource(
 *   id = "credit_cost_guidance_node"
 * )
 */
final class CreditCostGuidanceNode extends SqlBase {
  ...
  public function query(): SelectInterface {
    ...
    $query ->condition("n.type","credit_cost_guidance" );
  ...
  public function getFieldRecordTid($fieldName, $tid){
    $result = $this->select("field_data_{$fieldName}", 'f')
      ...
      ->condition('f.bundle', 'credit_cost_guidance', '=')
